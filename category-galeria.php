		...
		<div id="content" class="content_padding" role="main">
			...
			<?php
					...
					while ($query->have_posts() ) : $query->the_post();
						...
						$title = get_the_title();
						$gallery_icon_class = (($i % 4) == 0) ? "gallery_icon2" : "gallery_icon";
						$gallery_margin_bottom_class = $i <= 4 ? "gallery_margin_bottom" : "";
						$date = get_the_date("j.m.Y");
						$link = wp_get_shortlink();
						?>
						<a href="<?php echo $link; ?>">
						<div class="frame <?php echo "$gallery_icon_class $gallery_margin_bottom_class"; ?>">
				...
				<?php
						if (($i % 4) == 0) {
							echo "<div class=\"gallery_clear\"></div>";
						}
						$i++;
					endwhile;
					wp_reset_postdata();
